...
public class DeviceListActivity extends Activity {
    private static final String TAG = "DeviceListActivity";     //Tag for Log
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (mBtAdapter != null) {           // Make sure we're not doing discovery anymore
            mBtAdapter.cancelDiscovery();
        }
        this.unregisterReceiver(mReceiver); // Unregister broadcast listeners
    }
    private void doDiscovery() {            //Start device discover with the BluetoothAdapter
        ...
        if (mBtAdapter.isDiscovering()) {   // If we're already discovering, stop it
            mBtAdapter.cancelDiscovery();
        }
        mBtAdapter.startDiscovery();        // Request discover from BluetoothAdapter
    }
    private AdapterView.OnItemClickListener mDeviceClickListener    //The on-click listener for all devices in the ListViews
